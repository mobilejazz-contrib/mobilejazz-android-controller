...
public class SpinnerDataBinding<E> extends SelectableLoaderBinding<SpinnerCursorAdapter<E>, Cursor, E> {

	public SpinnerDataBinding(AdapterView<SpinnerCursorAdapter<E>> view, SpinnerCursorAdapter<E> adapter,
	...
	public SpinnerDataBinding(View parent, int resId, SpinnerCursorAdapter<E> adapter,
			LoaderFactory<Cursor> loaderFactory, LoaderManager loaderManager) {
