...
public class ObservableCursorLoader extends ObservableLoader<Cursor> {
	 ...
	 */
	public ObservableCursorLoader(Context context, Uri uri, String[] projection, String selection,
